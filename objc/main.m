...
//                NSLog(@"Programming in Objective-C in even more fun!");
//                NSLog(@"Testing...\n..1\n...2\n....3");
//                int sum;
//        
//                sum = 50 + 25;
...
//        
//                int value1, value2, nxsum;
//        
//                value1 = 50;
//                value2 = 25;
//                nxsum = value1 + value2;
//                NSLog(@"The sum of %i and %i is %i.", value1, value2, nxsum);
//        
...
//                NSLog(@"All program statements must terminated by a semicolon");
//                int a = 25;
//                int b = 2;
//                NSLog(@" a / b * b = %i", a / b * b);
    }
